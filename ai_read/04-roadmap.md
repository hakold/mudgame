...
## Phase 7: 内容深度扩展 🔶 IN PROGRESS

> 增加长期可玩性。已提交: Phase 5-6。工作区有未提交的 Phase 7-8 部分实现。

| # | 功能 | 状态 | 说明 |
|---|------|------|------|
| 7.1 | 门派专属技能树 | ⬜ | 每门派10-15技能，按rank分级 |
| 7.2 | 门派任务链 | 🔶 | factionQuests.json已就绪(8个任务)，缺少socket集成 |
| 7.3 | 副本系统 | ⬜ | 试炼/秘境/BOSS副本 |
| 7.4 | 帮派系统 | ⬜ | 创建/管理/帮战/仓库 |
| 7.5 | 生活技能 | 🔶 | 锻造已完成，采集/炼药/烹饪未开始 |
| 7.6 | 成就系统 | 🔶 | config+model+service+UI已就绪，未接入玩法触发点 |

## Phase 8: 经济与平衡 🔶 IN PROGRESS
